    ...
    const login =async()=>{
        try {
           const res=await auth.signInWithEmailAndPassword(email,pass)
            ...
            console.log(error)
            if(error.code==="auth/email-already-in-use"||error.code==="auth/userr-not-found"){
                setError("el email y/o la paswrd son invalidos")
            } 
        }
    }
            ...
            <div className="row justify-content-center">
                ...
                <div className="col-12 col-sm-8 col-md-6 col-xl-4">
                 ...
                 <form onSubmit={procesarDatos}>
                    ...
                    {
                        !esregistro &&(
                            <button className="btn btn-lg btn-danger btm-sm  mb-2 w-100" type="button"
                            onClick>
